...
struct SampleTool
{
    ...
    //新增代码.
    virtual int  getResultNum() { return 0; }
    virtual bool getResultByIndex(int index, float* out) { return false; }
};
...
public:
    ...
    int getResultNum() { return m_tool ? m_tool->getResultNum() : 0; }
    bool getResultByIndex(int index, float* out) { return m_tool ? m_tool->getResultByIndex(index, out) : false; }
